...
Sea $d \in D$ arbitrario, se necesita demostrar que existe un único (ya se ha demostrado que $f$ es inyectivo) elemento $p \in P$ tal que $f(p) = d$

Por definición de imagen es sabido que $f(p) = d \implies 5p = d \implies p = \frac{d}{5}$
...
Dado un $b \in \mathbb{Z}^-$, con $b$ impar, se necesita demostrar que existe un único $z \in \mathbb{Z}$, con $z \ge 0$, tal que $f(z) = b$.

Por definición de imagen se tiene que $f(z) = b \implies -2z - 1 = b \implies -2z = b + 1 \implies z = -\frac{b + 1}{2}$

Evaluar $z$ en la función $f$:
...
Dado un $b \in \mathbb{Z}^-$, con $b$ par, se necesita demostrar que existe un único $z \in \mathbb{Z}$, con $z < 0$, tal que $f(z) = b$.

Se sabe por definición de rango que $f(z) = b \implies 2z = b \implies z = \frac{b}{2}$

Evaluar $z$ en la función:
